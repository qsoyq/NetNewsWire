...
final class AppDefaults: Sendable {
	...
	struct Key {
		...
		static let hideReadFolders = "hideReadFolders"
	...
	var hideReadFolders: Bool {
		get {
			return AppDefaults.bool(for: Key.hideReadFolders)
		}
		set {
			AppDefaults.setBool(for: Key.hideReadFolders, newValue)
		}
	}
